...
<head>
	...
	<title>BimaLab - Supporting Insurance Innovation</title>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div id="logo" class="logo">
                            <a href="#" title="">
                                <img src="{{ asset('bimahub')}}/images/logo.png" alt="logo Finance Business" />
                            </a>
                        </div><!-- /#logo -->
                    </div>
                    <div class="col-lg-3 col-sm-6">
                ...
                <ul><!-- SLIDE  -->
                    ...
                    <li data-index="rs-3050" data-transition="slideremovedown" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"    data-rotate="0"  data-saveperformance="off"  data-title="Ken Burns" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">    <div class="overlay-black"></div>
                        ...
                        <div class="tp-caption title-slide color-white letter-spacing3px"
                            ...
                            style="z-index: 16; white-space: nowrap;">Growing insurance innovations
                        </div>
                    ...
                    <li data-index="rs-3049" data-transition="slideremovedown" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"    data-rotate="0"  data-saveperformance="off"  data-title="Ken Burns" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">     <div class="overlay-black"></div>
                        ...
                        <div class="tp-caption title-slide color-white letter-spacing3px"
                            ...
                            style="z-index: 16; white-space: nowrap;">BimaBox
                        </div>
                        ...
                        <div class="tp-caption sub-title color-white"
                            ...
                            style="z-index: 17; white-space: nowrap;">Providing an environment for individuals and businesses to innovate.
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="iconbox style5">
                            ...
                            <div class="iconbox-content">
                                <h3>Trainings</h3>
                                <p>Scheduling trainings and mentorship for innovators.</p>
                                <div class="btn-more">
                ...
                <div class="row">
                    <div class="col-lg-9 col-md-8">
                        <div class="text-download">
                            <h2>BimaBox: Want to test your innovation in the market?.</h2>
                            <p>Check the application form and guidance note on the side</p>
                        </div>
                    </div>
                ...
                <!--<div class="row">-->
                    <!--<div class="col-lg-3 col-md-6">-->
                        <!--<div class="widget-ft widget-about">-->
                            <!--<div id="logo-ft">-->
                                <!--<a href="#" title="">-->
                                    <!--<img src="{{ asset('bimahub')}}/images/logo-ft.png" alt="">-->
                                <!--</a>-->
                            <!--</div>-->
                            ...
                            <!--<ul class="social">-->
                                ...
                                <!--</li>-->
                            <!--</ul>   -->
                        <!--</div>&lt;!&ndash; /.widget-text &ndash;&gt;-->
                    <!--</div>&lt;!&ndash; /.col-md-3 col-sm-6 &ndash;&gt;-->
                    <!--<div class="col-lg-3 col-md-6">-->
                        <!--<div class="widget-ft widget-services">-->
                            ...
                            <!--<ul class="one-half first">-->
                                ...
                                <!--<li><a href="#" title="">BimaBox</a></li>-->
                                <!--<li><a href="#" title="">Blog</a></li>-->
                            <!--</ul>&lt;!&ndash; /.one-half &ndash;&gt;-->
                            <!--<ul class="one-half">-->
                        ...
                        <!--</div>&lt;!&ndash; /.widget-services &ndash;&gt;-->
                    <!--</div>&lt;!&ndash; /.col-md-3 col-sm-6 &ndash;&gt;-->
                    <!--<div class="col-lg-3 col-md-6">-->
                        <!--<div class="widget-ft widget-lastest">-->
                            ...
                            <!--<ul>-->
                                <!--&lt;!&ndash;<li>&ndash;&gt;-->
                                    <!--&lt;!&ndash;<a href="#" title=""><i class="fa fa-twitter"></i>@Themesflat</a> Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.&ndash;&gt;-->
                                <!--&lt;!&ndash;</li>&ndash;&gt;-->
                                <!--&lt;!&ndash;<li>&ndash;&gt;-->
                                    <!--&lt;!&ndash;<a href="#" title=""><i class="fa fa-twitter"></i>@Samon.D</a> Lorem Ipsum is simply dummy text of the printing and typesetting.Lorem Ipsum is simply dummy.&ndash;&gt;-->
                                <!--&lt;!&ndash;</li>&ndash;&gt;-->
                            <!--</ul>-->
                        <!--</div>&lt;!&ndash; /.widget-services &ndash;&gt;-->
                    <!--</div>&lt;!&ndash; /.col-md-3 col-sm-6 &ndash;&gt;-->
                    <!--<div class="col-lg-3 col-md-6">-->
                        <!--<div class="widget-ft widget-subscribe">-->
                            ...
                            <!--</form>-->
                        <!--</div>&lt;!&ndash; /.widget-subscribe &ndash;&gt;-->
                    <!--</div>&lt;!&ndash; /.col-md-3 col-sm-6 &ndash;&gt;-->
                <!--</div>&lt;!&ndash; /.row .widget-box &ndash;&gt;-->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="copyright">
                            <p>© BimaLab <a href="#" title="">BimaLab 2020</a>. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
